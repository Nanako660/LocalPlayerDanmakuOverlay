...
`[此处应放置一张控制面板的截图]`
![控制面板截图](https://i.imgur.com/g0tYJqY.png)

#### 弹幕与调试信息效果
弹幕清晰地悬浮在播放器之上。开启调试模式后，角落会显示一个带半透明背景的调试信息面板。

`[此处应放置一张视频播放时，弹幕和调试信息同时出现的截图]`
![弹幕与调试信息截图](https://i.imgur.com/kY3O6Zv.png)
...
1.  **克隆或下载项目**
    ```bash
    git clone [https://github.com/your-username/LocalPlayerDannakuOverlay.git](https://github.com/your-username/LocalPlayerDannakuOverlay.git)
